    ...
    <div class="nota">
        ...
        <div class="transaksi">
            <table>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal1"></td>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal2"></td>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal3"></td>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal4"></td>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal5"></td>
                ...
                <tr>
                    <td><input type="text" name="tanggal[]" id="tanggal6"></td>
                ...
                <tr>
                    <<td><input type="text" name="tanggal[]" id="tanggal7"></td>
